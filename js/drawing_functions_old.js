...
//		var cp0x = (x - 1.0 * branch_length + random0 * curvature_random_factor);
//		var cp0y = (H-y + curvature + random0 * curvature_random_factor);
//		var cp1x = (x + 1 + random1 * curvature_random_factor);
//		var cp1y = (H-y + 1 + random1 * curvature_random_factor);
//		var cp2x = (x + 1 + random2 * curvature_random_factor);
//		var cp2y = (H-y + 1 + random2 * curvature_random_factor);
//		var cp3x = (x + 1.0 * branch_length + random3 * curvature_random_factor);
//		var cp3y = (H-y + curvature + random3 * curvature_random_factor);

//		var cp0x = (x - 1.0 * branch_length + random0 * curvature_random_factor);
//		var cp0y = (y + curvature + random0 * curvature_random_factor);
//		var cp1x = (cp0x + random1 * curvature_random_factor);
//		var cp1y = (cp0y + random1 * curvature_random_factor);
//		var cp3x = (x + 1.0 * branch_length + random3 * curvature_random_factor);
//		var cp3y = (y + curvature + random3 * curvature_random_factor);
//		var cp2x = (cp3x + random2 * curvature_random_factor);
//		var cp2y = (cp3y + random2 * curvature_random_factor);
		
//		var cp0x2 = (x - cp0x) * Math.cos(spline_angle * 2 * Math.PI/360);
//		var cp0y2 = cp0y;
//		var cp1x2 = (x - cp1x) * Math.cos(spline_angle * 2 * Math.PI/360);
//		var cp1y2 = cp1y;
//		var cp2x2 = (x - cp2x) * Math.cos(spline_angle * 2 * Math.PI/360);
//		var cp2y2 = cp2y;
//		var cp3x2 = (x - cp3x) * Math.cos(spline_angle * 2 * Math.PI/360);
//		var cp3y2 = cp3y;
		var cp0x2 = (x - cp0x) * Math.cos(spline_angle * 2 * Math.PI/360);
		var cp0y2 = (y - cp0y) * Math.sin(spline_angle * 2 * Math.PI/360);
		var cp1x2 = Math.sqrt(cp0x2*cp0x2 + cp0y2*cp0y2)*Math.atan(cp0y2/cp0x2) * Math.cos(spline_angle * 2 * Math.PI/360);
		var cp1y2 = Math.sqrt(cp0x2*cp0x2 + cp0y2*cp0y2)*Math.atan(cp0y2/cp0x2) * Math.sin(spline_angle * 2 * Math.PI/360);
		//var cp2x2 = (x - cp2x) * Math.cos(spline_angle * 2 * Math.PI/360);
		//var cp2y2 = (y - cp2y) * Math.sin(spline_angle * 2 * Math.PI/360);
		var cp3x2 = (x - cp3x) * Math.cos(spline_angle * 2 * Math.PI/360);
		var cp3y2 = (y - cp3y) * Math.sin(spline_angle * 2 * Math.PI/360);
		var cp2x2 = Math.sqrt(cp3x2*cp3x2 + cp3y2*cp3y2)*Math.atan(cp3y2/cp3x2) * Math.cos(spline_angle * 2 * Math.PI/360);
		var cp2y2 = Math.sqrt(cp3x2*cp3x2 + cp3y2*cp3y2)*Math.atan(cp3y2/cp3x2) * Math.sin(spline_angle * 2 * Math.PI/360);
		//console.log(cp0x2 + " " + cp1x2 + " " + cp2x2 + " " + cp3x2);
		console.log(cp0y2 + " " + cp1y2 + " " + cp2y2 + " " + cp3y2);
...
//		var cp3y3 = y + cp3y2;
		...
		var cp2y3 = H - (y + cp2y2);
		var cp3y3 = H - (y + cp3y2);
		//console.log(cp0x3 + " " + cp1x3 + " " + cp2x3 + " " + cp3x3);
		console.log(cp0y3 + " " + cp1y3 + " " + cp2y3 + " " + cp3y3);
		
//		var cp0x = $("#root_node_scale").val()*(x - 1.0*branch_length + random0*10);
//		var cp0y = $("#root_node_scale").val()*(H-y + 1 + random0*10);
//		var cp1x = $("#root_node_scale").val()*(x + 1 + random1*10);
//		var cp1y = $("#root_node_scale").val()*(H-y + 1 + random1*10);
//		var cp2x = $("#root_node_scale").val()*(x + 1 + random2*10);
//		var cp2y = $("#root_node_scale").val()*(H-y + 1 + random2*10);
//		var cp3x = $("#root_node_scale").val()*(x + 1.0*branch_length + random3*10);
//		var cp3y = $("#root_node_scale").val()*(H-y + 1 + random3*10);

		ctx.beginPath();
		ctx.moveTo(cp0x3,cp0y3);
		ctx.bezierCurveTo(cp1x3, cp1y3, cp2x3, cp2y3, cp3x3, cp3y3);
		ctx.stroke();
	}
